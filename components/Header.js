    ...
    <header className="bg-light-bg text-light-text dark:bg-dark-bg dark:text-dark-text transition-colors duration-500 p-6">
      <div className="container flex mx-auto flex-wrap items-center">
        ...
        <nav className="md:ml-auto flex items-center justify-between">
          ...
          <button aria-label="Toggle Dark Mode" type="button" className="p-3 h-12 w-12 order-2 md:order-3 hover:text-light-hover dark:hover:text-dark-hover" onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
